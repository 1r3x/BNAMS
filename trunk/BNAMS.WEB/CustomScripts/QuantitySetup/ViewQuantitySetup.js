var viewGunModelTypeSetup = {
    ...
    GetGunModelTypeSetupDataTable: function () {
        ...
        $("#dataTable").DataTable({
            ...
            "scrollX": true,
            "ajax": {
                "url": "/QuantitySetup/GetAllQuantitySetup",
                "type": "GET",
                "datatype": "json",
                "contentType": "application/json; charset=utf-8"
            },
            "columns": [
                { "data": "QuantityCode", "autoWidth": true },
                { "data": "QuantityName", "autoWidth": true },
                {
                    "data": "CreateDate",
                    "type": "date",
...
var viewGunModelTypeSetupHelper = {
    ...
    populateDataForEditButton: function (aObj) {
        debugger;
        $("#hdnQuantityId").val(aObj.QuantityId);
        $("#txtQuantityCode").val(aObj.QuantityCode);
        $("#txtQuantityName").val(aObj.QuantityName);
