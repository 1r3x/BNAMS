var viewGunModelTypeSetup = {
    ...
    GetGunModelTypeSetupDataTable: function () {
        ...
        $("#dataTable").DataTable({
            ...
            "scrollX": true,
            "ajax": {
                "url": "/StatusInformation/GetAllStatusInformationSetup",
                "type": "GET",
                "datatype": "json",
                "contentType": "application/json; charset=utf-8"
            },
            "columns": [
                { "data": "StatusCode", "autoWidth": true },
...
var viewGunModelTypeSetupHelper = {
    ...
    populateDataForEditButton: function (aObj) {
        debugger;
        $("#hdnStatusInformationId").val(aObj.StatusId);
        $("#txtStatusCode").val(aObj.StatusCode);
        $("#txtStatusName").val(aObj.StatusName);
