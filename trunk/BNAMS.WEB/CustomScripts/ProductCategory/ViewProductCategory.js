var viewProductCategory = {

    GetProductCategoryDataTable: function () {
        $("#dataTable").dataTable().fnDestroy();
        $("#dataTable").DataTable({

            "scrollX": true,
            "ajax": {
                "url": "/ProductCategory/GetAllProductCaegoryMasterSetup",
                "type": "GET",
                "datatype": "json",
...
var viewProductCategoryHelper = {


    populateDataForEditButton: function (aObj) {
        debugger;
        $("#hdnProductCategoryId").val(aObj.ProductCategoryId);
        $("#txtProductCategoryName").val(aObj.ProductCtegoryName);
